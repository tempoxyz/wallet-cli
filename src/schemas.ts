...
export const loginOutput = z.union([whoamiOutput, z.object({
...
export const transferOutput = z.union([transferDryRunOutput, transferSuccessOutput, spendCreditsOutput])
